...
export default () => (
  <Container col={8}>
    ...
    <p>
      Previously, I had an internship where I worked as a web developer and built a full-stack web application to help manage, review and generate reports of health facility data.
    </p>
  </Container>
)